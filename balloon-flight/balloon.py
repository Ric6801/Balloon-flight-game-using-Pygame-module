...
def update_high_scores():
    global score, scores
    filename = r"C:\Users\Richa\Desktop\python-games\balloon-flight\high-scores.txt"
    scores = []
...
def display_high_scores():
    ...
    position = 1
    for high_score in scores:
        screen.draw.text(str(position) + ". " + high_score, (30, y), color="black")
        y += 25
        position += 1
